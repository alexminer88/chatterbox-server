...
// var data = require('../sampleData/sampleData.js');
...
var requestHandler = function(request, response) {  
  ...
  // console.log('Test destination: ' + request.destination + ', and the context: ' + request.url);
  // The outgoing status.
  var statusCode = 200;
  ...
  // if request.url matches `Our URL`/chatterbox/classes/messages
